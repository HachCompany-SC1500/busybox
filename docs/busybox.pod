...
Currently available applets include:
	...
	[, [[, acpid, addgroup, adduser, ash, awk, base64, basename, beep,
	blkid, blockdev, bunzip2, bzcat, bzip2, cat, chcon, chgrp, chmod,
	chown, chroot, chvt, cksum, clear, cmp, conspy, cp, cpio, crond,
	crontab, cut, date, dd, deallocvt, delgroup, deluser, devmem, df,
	dhcprelay, diff, dirname, dmesg, dnsd, dnsdomainname, du,
	dumpleases, echo, egrep, env, expr, false, fbset, fgconsole, fgrep,
	find, flock, free, fstrim, fsync, ftpd, ftpget, ftpput, getenforce,
	getopt, getsebool, getty, grep, groups, gunzip, gzip, halt, head,
	hexdump, hostname, httpd, hwclock, id, ifconfig, ifplugd, init,
	insmod, install, ionice, iostat, ipcrm, ipcs, kill, killall, klogd,
	less, linuxrc, ln, load_policy, logger, login, logname, logread, ls,
	lsmod, lsof, lspci, lsusb, makemime, matchpathcon, md5sum, mdev,
	mkdir, mkdosfs, mke2fs, mkfifo, mkfs.ext2, mkfs.vfat, mknod, mktemp,
	modinfo, modprobe, more, mount, mountpoint, mpstat, mv, nanddump,
	nandwrite, nbd-client, nc, netstat, nice, nohup, nslookup, ntpd, od,
	openvt, passwd, pidof, ping, pivot_root, pmap, popmaildir, poweroff,
	powertop, printenv, printf, ps, pscan, pstree, pwd, pwdx, rdate,
	readlink, realpath, reboot, reformime, renice, reset, resize,
	restorecon, rev, rm, rmdir, rmmod, route, runcon, scriptreplay, sed,
	selinuxenabled, seq, sestatus, setconsole, setenforce, setfiles,
	setkeycodes, setlogcons, setsebool, setserial, sh, sha1sum,
	sha256sum, sha3sum, sha512sum, slattach, sleep, smemcap, sort,
	split, stat, strings, stty, sum, swapoff, swapon, sync, syslogd,
	tail, tar, tee, test, tftp, time, timeout, top, touch, tr, true,
	tty, tunctl, ubiattach, ubidetach, ubimkvol, ubirmvol, ubirsvol,
	ubiupdatevol, udhcpc, udhcpd, umount, uname, uniq, unxz, unzip,
	uptime, users, usleep, vi, volname, wall, watch, watchdog, wc,
	which, who, whoami, whois, xargs, xz, xzcat, yes, zcat
...
ls [-1AaCxdLHRFplinsehrSXvctukKZ] [-w WIDTH] [FILE]...
